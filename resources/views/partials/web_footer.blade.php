<footer id="footer">
    ...
    <div class="footer-bottom">
        ...
        <div class="container footer-box clearfix">
            <div class="copyright wow fadeInLeft" data-wow-delay="0.2s">&copy; Copyright <span>@php echo(date("Y",time())); @endphp</span>, All Rights Reserved By <a class="text-white" href="#" target="_blank">{{ $setting->company_name }}</a></div>
