                ...
                <div class="card">
                    ...
                    <div class="card-body b-card-body bg-light rounded px-2 px-md-3 py-1 py-md-1" style="font-size: 0.9rem">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="designation" class="form-control form-control-sm" id="designation" aria-describedby="designation" placeholder="Enter Full Designation"  value="{{ $team->designation }}">
                        ...
                        <div class="mb-3">
                            ...
                            <img id="output1" src="{{ asset('img/team/' . $team->image) }}" style="max-width: 140px; max-height: 120px; padding-top: 0.5rem"/>
                        </div>
                        <hr style="margin-top: 0.5rem; margin-bottom: 0.3rem; opacity: 0.1">
